...
export const plannerRequest="/payment/initialize-planner-request"
export const getAllUserPayments="/payment/get-user-payment"
export const deletePaymentRequest="/payment/delete-user-payment-request"
export const attendEvent="/events/attend-event"