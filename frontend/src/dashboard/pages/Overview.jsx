  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-[#fcd34d] p-4 rounded-md shadow-md transition-transform transform hover:scale-105">
          <h2 className="text-xl text-black font-semibold mb-2">
            Students Registered
          </h2>
          <p className="text-2xl text-black font-bold">543</p>
        </div>
        <div className="bg-[#f43f5e] p-4 rounded-md shadow-md transition-transform transform hover:scale-105">
